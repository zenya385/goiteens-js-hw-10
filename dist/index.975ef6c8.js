...
var _hw08Js = require("./js/hw-08.js");
var _hw09Js = require("./js/hw-09.js");
//!=================================hw-08====================================================
_hw08Js.increment.addEventListener("click", _hw08Js.plusOne);
_hw08Js.decrement.addEventListener("click", _hw08Js.minusOne);
_hw08Js.inputText.addEventListener("input", _hw08Js.setOutput);
//!=================================hw-09====================================================
_hw09Js.toggle.addEventListener("click", _hw09Js.changeListenerBtn);

},{"./js/hw-08.js":"9ayxa","./js/hw-09.js":"ak1ss"}],"9ayxa":[function(require,module,exports) {
...
const setOutput = (event)=>{
    ...
    if (outputText.textContent.trim() === "") outputText.textContent = "Anonymous";
};
...
},{}],"ak1ss":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const changeListenerBtn = ()=>{
    if (toggle.checked) btnChangeColor.addEventListener("click", changeColorOnClick);
    else btnChangeColor.removeEventListener("click", changeColorOnClick);
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequire97f4")
